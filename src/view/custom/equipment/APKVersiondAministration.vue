      ...
      <div>
        ...
        <Table border ref="selection" :columns="columns" :data="datas">
          ...
          <template slot-scope="{ row, index }"  slot="edit">
            <Button type="success" size="small" class='marBtn' @click='enable(row,index)' v-show='row.enable==0'>启用</Button>
            <Button type="error" size="small" class='marBtn' @click='enable(row,index)' v-show='row.enable==1'>禁用</Button>
            <Button type="success" size="small" class='marBtn' @click='Release(row,index)' v-show='row.publishStatus==0'>发布</Button>
