<template>
  <div class='pointInformation'>
    <div>
        ...
        <Button  type="primary" @click='replace' :disabled='!tableRowData' class='xzbtn' >更改设备</Button>
        <Table :highlight-row='true' border ref="selection" :columns="columns" :data="datas" @on-row-click='tableClick'>
          ...
          <template slot-scope="{ row, index }" slot="edit">
              ...
              <Button type="error" size="small" class='marBtn' v-show='row.machineCode' @click.stop='untying(row,index)'>解绑设备</Button>
              <Button type="primary" size="small" class='marBtn' v-show='!row.machineCode' @click.stop='binded(row)'>绑定设备</Button>
              <Button type="primary" size="small" class='marBtn' @click.stop='showNewlyAdded("bj",index)'>编辑</Button>
              <Button type="error" size="small" @click.stop="itemDelete(row,index)" >删除</Button>
          </template>
