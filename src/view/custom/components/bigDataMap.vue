...
export default {
  ...
  props:{
    ...
    dataList:{
      default:()=>{
        return [
          {enable:1,longitude:113.864691,laytitude:22.942327},
          {enable:2,longitude:120.412618,laytitude:36.382612},
          {enable:3,longitude:113.370643,laytitude:22.938827},
          {enable:4,longitude:113.001181,laytitude:23.120518},
          {enable:5,longitude:113.890205,laytitude:22.798043},
        ];
      }
    }
  },
